...
.d-right-modal(:style="{ padding: '10px' }")
	...
	c-control
		template(slot="right")
			c-input(append="W", :value="editor.screen.screenWidth", :style="{ width: '100px' }", @input="widthChange")
			c-input(
				append="H",
	...
	c-control(label="背景色")
		template(slot="right")
			c-color(v-model="editor.screen.screenBackGroundColor", v-if="editor.screen.screenBackGroundColor")
